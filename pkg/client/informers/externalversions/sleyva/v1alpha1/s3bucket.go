	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SleyvaV1alpha1().S3Buckets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SleyvaV1alpha1().S3Buckets(namespace).Watch(options)
			},
		},
		&sleyva_v1alpha1.S3Bucket{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *s3BucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sleyva_v1alpha1.S3Bucket{}, f.defaultInformer)
}
