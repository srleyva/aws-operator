...
var s3bucketsResource = schema.GroupVersionResource{Group: "sleyva", Version: "v1alpha1", Resource: "s3buckets"}

var s3bucketsKind = schema.GroupVersionKind{Group: "sleyva", Version: "v1alpha1", Kind: "S3Bucket"}
